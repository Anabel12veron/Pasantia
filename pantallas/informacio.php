...
<body class="fondo">
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            <!-- diseño/estilos de los carruseles -->
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <!-- detalle de la función que cumple el botón del Registrar -->
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                 <!-- detalle de la función que cumple el botón del Registros del programador -->
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                 <!-- detalle de la función que cumple el botón del Proyctos -->
...
<div class="card" style="width: 19rem;">
        ...
        <div class="card-body">
            <!-- información y descripción de que es UPSTI -->
    ...
    <div class="card" style="width: 19rem;">
        ...
        <div class="card-body">
            <!-- Información de lo que contiene y la función que realiza el botón registrar -->
    ...
    <div class="card" style="width: 19rem;">
        ...
        <div class="card-body">
            <!-- Información de lo que contiene y la función que realiza el botón registros del programador -->
    ...
    <div class="card" style="width: 19rem;">
        ...
        <div class="card-body">
            <!-- Información de lo que contiene y la función que realiza el botón registros del Proyecto -->
    ...
    <div class="card" style="width: 19rem;">
        ...
        <div class="card-body">
        <div class="card-body">
            <!-- Información de lo que contiene y la función que realiza el botón registros del comentarios -->
